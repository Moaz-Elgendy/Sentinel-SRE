// A deliberately small, consistent icon set (24px grid, 1.75 stroke). Inline
// SVG so the bundle stays dependency-free. Icons are decorative by default —
// pair with visible text or an aria-label on the parent control.
const PATHS = {
  dashboard: (
    <>
...
// The brand mark reuses the geometry of public/favicon.svg so the sidebar,
// login screen and browser tab all show the same shield.
export function BrandMark({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden="true" focusable="false">
      <path d="M16 2 L28 7 V15 C28 23 22 28 16 30 C10 28 4 23 4 15 V7 Z" fill="#12b76a" />
      <path
